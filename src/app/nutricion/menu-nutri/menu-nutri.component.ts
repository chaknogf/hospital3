...
/** Menú de acceso a citas y consultas de nutrición. */
@Component({
  selector: 'app-menu-nutri',
  templateUrl: './menu-nutri.component.html',
  styleUrls: ['./menu-nutri.component.css'],
  standalone: true,
  changeDetection: ChangeDetectionStrategy.Eager,
  imports: [RouterModule]
})

export class MenuNutriComponent implements OnInit {

  title = 'Nutrición';
  subtitle = 'Consulta externa, citas y reportes de nutrición';
  accent = '#fbbf24';
  menuColor = menuColor;
