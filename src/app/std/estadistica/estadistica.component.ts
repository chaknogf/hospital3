...
export class EstadisticaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.options = [
      ...
      { nombre: 'Procedimientos', descripcion: 'Registro de procedimientos menores y mayores', ruta: '', icon: '' },
      { nombre: 'Nacimientos', descripcion: 'Registro de Nacimientos', ruta: '', icon: '' },
