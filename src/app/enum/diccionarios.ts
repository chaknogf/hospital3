...
export const idiomas: Dict[] = [
  ...
  { label: 'Kaqchikel', value: 10 },
  { label: 'K’iche’', value: 11 },
  { label: 'Mam', value: 12 },
  { label: 'Mopan', value: 13 },
  { label: 'Poqomam', value: 14 },
  { label: 'Pocomchi’', value: 15 },
...
export const parentescos: Dict[] = [
  ...
  { label: 'Abuelo/a', value: 5 },
  { label: 'Tío/a', value: 6 },
  { label: 'Primo/a', value: 7 },
  { label: 'Sobrino/a', value: 8 },
  { label: 'Yerno/Nuera', value: 9 },
  { label: 'Esposo/a', value: 10 },
  { label: 'Suegro/a', value: 11 },
  { label: 'Tutor', value: 12 },
  { label: 'Amistad', value: 13 },
  { label: 'Novio/a', value: 14 },
  { label: 'Cuñado/a', value: 15 },
  { label: 'Nieto/a', value: 16 },
  { label: 'Hijastros', value: 17 },
  { label: 'Padrastros', value: 18 },
  { label: 'Otro', value: 19 },
];
