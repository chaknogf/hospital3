...
export class ConstanciasNacimientoComponent implements OnInit, OnDestroy {
  ...
  private poblarFormulario(c: ConstanciaNacimiento): void {
    this.form.patchValue({
      ...
      personal_atencion_id: c.paciente?.datos_extra?.neonatales?.id_medico ?? c.personal_atencion_id ?? null,
  ...
  private construirPayload(): any {
    ...
    return {
      ...
      personal_atencion_id: (this.constancia?.paciente?.datos_extra?.neonatales?.id_medico ?? v.personal_atencion_id) || undefined,
