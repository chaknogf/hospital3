...
/** Presenta la hoja de consulta externa de psicología. */
@Component({
  selector: 'app-HojaCoexPsico',
  templateUrl: './HojaCoexPsico.component.html',
  styleUrls: ['./HojaCoexPsico.component.css'],
  standalone: true,
  changeDetection: ChangeDetectionStrategy.Eager,
  imports: [DatosExtraPipe, EdadPipe, DatePipe, CuiPipe, TimePipe, CommonModule, VecindadPipe],
})
export class HojaCoexPsicoComponent implements OnInit, OnDestroy {
